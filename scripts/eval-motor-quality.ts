...
const profiles: EvalProfile[] = [
  ...
  // ─── 2. PnR handler élite ─────────────────────────────────────────────────
  {
    ...
    quality: [
      ...
      { label: "FORCE mentions direction (left/right)", force_contains: ["left", "right", "direction", "force"] },
  ...
  // ─── 6. Pressure liability — manejo terrible ─────────────────────────────
  {
    ...
    quality: [
      ...
      { label: "ALLOW mentions ball handling", allow_contains: ["ball", "handling", "dribble", "limited"] },
  ...
  // ─── 7. Tiradora spot-up primaria — sin creación ─────────────────────────
  {
    ...
    quality: [
      ...
      { label: "DENY mentions corners/closeout/catch", deny_contains: ["corner", "closeout", "catch", "contest"] },
      { label: "DENY text is professional (>40 chars)", deny_min_length: 40 },
      { label: "ALLOW mentions ISO (no creation)", allow_contains: ["iso", "isolation", "creat", "dribble"] },
  ...
  // ─── 8. Big transition rim runner ────────────────────────────────────────
  {
    ...
    quality: [
      ...
      { label: "DENY mentions transition/rim/basket/sprint", deny_contains: ["rim", "sprint", "transition", "basket", "run"] },
      { label: "ALLOW mentions spot-up/threes/perimeter", allow_contains: ["spot", "three", "perimeter", "range"] },
  ...
  // ─── 9. ISO handler bajo presión — lucha en PnR ──────────────────────────
  {
    ...
    quality: [
      ...
      { label: "FORCE mentions trap/hedge/blitz", force_contains: ["trap", "hedge", "blitz", "struggle"] },
