...
export function PlayerTeamView() {
  ...
  if (isLoading) {
    return (
      <div className="flex items-center justify-center h-app bg-background">
  ...
  if (isError || !data) {
    return (
      <div className="flex flex-col h-app bg-background px-4 pt-10">
  ...
  return (
    <div className="flex flex-col h-app overflow-hidden bg-background text-foreground pb-16 md:pb-0">
