...
export const MOTOR_V2_1_I18N = {
  en: {
    ...
    'output.identity.role__es_m': 'Role player',
    'output.identity.role__es_f': 'Role player',
  ...
  es: {
    ...
    'output.deny.trans_trail': 'NEGAR triple en trail — identificar el tiro pronto',
    ...
    'output.deny.trans_runner_corner': 'NEGAR triple de esquina en carrera — localizar el disparo',
    ...
    // ============= AWARE OUTPUTS =============
    'output.aware.passer': 'Pase de nivel élite — no forzar robos',
    'output.aware.trap': 'Maneja bien trampas - rotar rápido',
    'output.aware.physical': 'Finalización con contacto — esperar choques',
    'output.aware.deep': 'Amenaza profunda - defender hasta medio campo',
    'output.aware.hands': 'Finaliza con ambas manos',
    'output.aware.oreb': 'Rebote ofensivo de élite — bloquear cada tiro',
    ...
    'output.aware.trans_trail_shoot': 'Disparo en trail tras drag — detectar tarde',
    ...
    'output.aware.off_ball_flare': 'Triple en flare desde pantallas — pasar bajo o cambiar',
    'output.aware.high_post_face_up': 'Ataque de frente desde el codo — stance en gap',
    'output.aware.high_post_passer': 'Distribución desde poste alto — negar cortes',
    ...
    'output.aware.iso_weak_hand_finish': 'Con mano débil forzada: prefiere {finish}.',
    ...
    'output.identity.role': 'Perfil de rol / opción secundaria',
    'output.identity.role__es_m': 'Jugador de rol',
    'output.identity.role__es_f': 'Jugadora de rol',
    ...
    // ============= v2.1 - TRANSITION ROLE LABELS =============
    'output.trans_role.rim_run': 'Carrera al aro',
    'output.trans_role.trail': 'Trailer (3PT)',
    'output.trans_role.leak': 'Escape temprano',
    'output.trans_role.fill': 'Relleno de espacios',
  ...
  zh: {
    ...
    'output.identity.role__es_m': '角色球员',
    'output.identity.role__es_f': '角色球员',
