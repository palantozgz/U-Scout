...
const en = {
  ...
  approval_unpublish_confirm: "Unpublish this scouting report? It will no longer be visible to players. Continue?",
...
const es: I18nStrings = {
  ...
  approval_unpublish_confirm:
    "¿Despublicar este informe de scouting? Los jugadores dejarán de verlo. ¿Continuar?",
...
const zh: I18nStrings = {
  ...
  approval_unpublish_confirm: "取消发布此球探报告？球员将无法再查看。是否继续？",
