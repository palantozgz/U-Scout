...
const en = {
  ...
  hint_motor_ball_handling: "How reliably she protects the ball and advances against pressure — feeds ball-security weights in the motor.",
  hint_motor_pressure: "How she responds to traps and full-court pressure — affects denial and trap recommendations.",
  ...
  hint_motor_post_entry: "How she typically receives the ball in the post — informs post-trap and fronting logic.",
  hint_motor_post_entry_secondary: "Optional second entry pattern when she mixes multiple ways to get deep position.",
  ...
  hint_motor_trans_rim: "How often she attacks the rim in transition (lobs, layups, rim runs). Compared with trail three to pick rim runner vs trailer in the motor.",
  hint_motor_trans_trail: "How often she trails for a transition three. Compared with rim attack to pick trailer vs rim runner in the motor.",
  ...
  "editor.transition_role_hint": "What is her primary role when running in transition?",
  ...
  "editor.rim_run_frequency_hint": "How often does she attack the rim in transition?",
  "editor.trail_frequency": "Trail frequency",
  "editor.trail_frequency_hint": "How often is she the trail player?",
  "editor.screener_action": "Action after screen",
  "editor.screener_action_hint": "What does she do after setting the screen?",
...
const es: I18nStrings = {
  ...
  review_runner_ups_hint:
    "Opciones que el motor rankea después de la carta principal — con peso. La jugadora no lo ve; úsalo si quieres otro mensaje en el informe publicado.",
