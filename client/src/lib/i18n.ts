...
const es: I18nStrings = {
  ...
  hint_motor_ball_handling: "Qué tan fiable protege el balón y avanza bajo presión — alimenta el peso de seguridad de bote en el motor.",
  ...
  hint_motor_trans_trail: "Con qué frecuencia arrastra para triple en transición. Se compara con el ataque al aro para trailer vs rim runner en el motor.",
  ...
  "editor.ball_handling.liability": "Débil",
  "editor.pressure_response": "Respuesta a Presión",
  "editor.pressure.breaks": "Rompe Presión",
  ...
  "editor.trans_role.rim_runner": "Rim runner",
  "editor.trans_role.trail": "Trail",
  "editor.trans_role.runner": "Corredor",
  "editor.trans_role.pusher": "Impulsor",
  ...
  "editor.dunker_spot_hint": "Tendencia a posicionarse en el dunker spot en ataque de media cancha",
...
const zh: I18nStrings = {
  ...
  hint_motor_ball_handling: "护球与在压迫下推进的可靠程度 — 影响电机中的控球安全权重。",
  hint_motor_pressure: "面对全场紧逼与夹击时的表现 — 影响夹击与压迫防守建议。",
  hint_post_profile_secondary: "可选 — 适合内外兼修的球员（如空间型内线兼低位）。用于球探备注；电机目前仍以主档案为准。",
  hint_motor_post_eff: "低位终结效率的观察结论 — 影响电机中低位协防与顶防权重。",
  hint_motor_post_entry: "她通常如何要到低位接球 — 影响低位夹击与绕前逻辑。",
  hint_motor_post_entry_secondary: "当她有多种要位方式时的第二种进入模式（可选）。",
  hint_motor_post_moves_quadrant: "电机从格子中读取低位动作 — 不必再用通用勾选项重复填写。",
  hint_iso_finish_eff: "单打终结/得分的观察效率 — 影响电机中单防与夹击权重。",
  hint_pnr_finish_eff: "作为挡拆持球人时的终结效率 — 设置后影响电机中对持球挡拆的压迫权重。",
  hint_motor_trans_rim: "快攻中多常冲击篮下（空接、上篮、冲框）。与拖后三分对比，用于电机区分冲框者与拖后投手。",
  hint_motor_trans_trail: "快攻中多常拖后投三分。与冲框对比，用于电机区分拖后投手与冲框者。",
