...
const en = {
  ...
  club_league_infer_toast: "Gender and level were preset from the league.",
  club_league_nba: "NBA",
...
const es: I18nStrings = {
  ...
  club_league_infer_toast: "Género y nivel preseleccionados según la liga.",
  club_league_nba: "NBA",
...
const zh: I18nStrings = {
  ...
  club_league_infer_toast: "已根据联赛预设性别与水平。",
  club_league_nba: "NBA",
