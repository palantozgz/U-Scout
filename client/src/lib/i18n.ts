...
const en = {
  ...
  club_ctx_hint: "Feeds motor v3 to tune defensive scouting outputs for your league.",
...
const es: I18nStrings = {
  ...
  club_ctx_hint: "Alimenta el motor v3 para ajustar los informes defensivos a tu competición.",
  club_ctx_viewer_hint:
...
const zh: I18nStrings = {
  ...
  club_ctx_hint: "供 motor v3 根据联赛环境微调防守球探输出。",
