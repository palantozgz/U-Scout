...
const en = {
  ...
  "editor.iso_finish_drive": "Attack the rim",
  "editor.iso_finish_pullup": "Pull-up",
  "editor.iso_finish_floater": "Floater",
  "editor.iso_finish_pass": "Pass",
  ...
  "editor.off_ball_role_hint": "Does this player typically play as screener, cutter, or both?",
  "editor.off_ball_role_screener": "Screener",
  "editor.off_ball_role_cutter": "Cutter",
  "editor.off_ball_role_both": "Both",
  "editor.off_ball_role_none": "Doesn't play off-ball",
...
const es: I18nStrings = {
  ...
  "editor.iso_finish_drive": "Finalizar en el aro",
  "editor.iso_finish_pullup": "Tirar",
  "editor.iso_finish_floater": "Floater",
  "editor.iso_finish_pass": "Pasar",
  "editor.iso_strong_hand_finish": "Finalización con mano fuerte",
  "editor.iso_strong_hand_finish_hint": "Movimiento preferido cuando ataca con su mano dominante en ISO",
  "editor.iso_weak_hand_finish": "Finalización con mano débil",
  "editor.iso_weak_hand_finish_hint": "Movimiento preferido cuando se ve obligada a atacar con su mano débil",
  "editor.off_ball_role": "Rol en Off-Ball",
  "editor.off_ball_role_hint": "¿Este jugador actúa como bloqueador, bloqueado, o ambos?",
  "editor.off_ball_role_screener": "Bloqueador",
  "editor.off_ball_role_cutter": "Bloqueado",
  "editor.off_ball_role_both": "Ambos",
  "editor.off_ball_role_none": "No juega off-ball",
...
const zh: I18nStrings = {
  ...
  "editor.iso_finish_drive": "上篮终结",
  "editor.iso_finish_pullup": "跳投",
  "editor.iso_finish_floater": "浮投",
  "editor.iso_finish_pass": "传球",
  "editor.iso_strong_hand_finish": "强手终结",
  "editor.iso_strong_hand_finish_hint": "用强手单打时的优先终结方式",
  "editor.iso_weak_hand_finish": "弱手终结",
  "editor.iso_weak_hand_finish_hint": "被迫用弱手时的优先终结方式",
  "editor.off_ball_role": "挡拆角色",
  "editor.off_ball_role_hint": "该球员通常是挡拆者、被挡拆者还是两者兼备？",
  "editor.off_ball_role_screener": "挡拆者",
  "editor.off_ball_role_cutter": "被挡拆者",
  "editor.off_ball_role_both": "两者",
  "editor.off_ball_role_none": "不参与挡拆",
