...
const en = {
  ...
  iso_opposite_finish: "Finishes with opposite hand?",
  opt_iso_opposite_yes: "Yes (eurostep / off-hand)",
  opt_iso_opposite_no: "No (strong hand only)",
  ...
  hint_iso_opposite_finish: "When forced to their weaker side, what do they do? This becomes the 'Force' direction in the defensive plan.",
  ...
  "editor.putback_converts": "Converts well",
  "editor.putback_capable": "Capable",
...
const es: I18nStrings = {
  ...
  iso_opposite_finish: "¿Finaliza con la mano contraria?",
  opt_iso_opposite_yes: "Sí (eurostep / mano débil)",
  opt_iso_opposite_no: "No (siempre dominante)",
  ...
  "editor.putback_converts": "Convierte bien",
  "editor.putback_capable": "Capaz",
...
const zh: I18nStrings = {
  ...
  iso_opposite_finish: "反手终结？",
  opt_iso_opposite_yes: "是（欧洲步/反手）",
  opt_iso_opposite_no: "否（总用强手）",
  ...
  "editor.putback_converts": "高效转化",
  "editor.putback_capable": "有一定能力",
