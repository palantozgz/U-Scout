...
// U mark — cuernos (parte A, D=25 clip) + conector (parte B, D=25 scale)
const U_HORNS_PATH =
...
export function ModuleHeader({ module, tagline, className }: ModuleHeaderProps) {
  ...
  return (
    ...
    >
      ...
      {/* U mark — mismo tamaño y viewBox en todos. D=25: clip en y=427, connector escalado */}
      <svg
      ...
      >
        <defs>
          <clipPath id="module-horn-clip">
            <rect x={0} y={0} width={1024} height={427} />
          </clipPath>
        </defs>
        <g clipPath="url(#module-horn-clip)">
