 ...
 * Usa el U mark (solo el símbolo, sin las letras SCOUT) + wordmark HTML por módulo.
 * Mismo tamaño, animación y estilo tipográfico que CoachHome.
 */
...
// U mark path completo (viewBox 0 0 1024 1024)
// Solo los 3 primeros subpaths = las dos alas + el puente (sin las letras SCOUT)
const U_MARK_ONLY_PATH =
...
export function ModuleHeader({ module, tagline, className }: ModuleHeaderProps) {
  ...
  return (
    <div
      ...
      style={{ paddingTop: "2rem", paddingBottom: "1.5rem", gap: "0.5rem" }}
    >
      {/* Settings — top right */}
      <button
        type="button"
      ...
      {/* U mark — solo el símbolo (sin SCOUT), mismo tamaño que CoachHome */}
      <svg
        viewBox="260 300 510 210"
        style={{ height: 204, width: 204, display: "block", color: "currentColor" }}
        aria-hidden
      >
        <path fill="currentColor" fillRule="evenodd" clipRule="evenodd" d={U_MARK_ONLY_PATH} />
      </svg>

      {/* Wordmark — mismo estilo tipográfico exacto que CoachHome */}
      <span
        style={{
          fontSize: "11px",
          letterSpacing: "0.2em",
