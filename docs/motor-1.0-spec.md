...
**`[PENDIENTE PRODUCTO, NO TÉCNICO]`, señalado en el código, no decidido aquí:** ¿qué debe mostrar la Capa 0 del modo sencillo cuando una jugadora no tiene ninguna situación que "merezca" una acción de deny? El tipo ya permite la ausencia (`accionPrincipal?`); falta decidir el diseño de esa pantalla — sección 7 de la spec, criterio de Pablo.
